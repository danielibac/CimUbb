...
public class NXTTalker {
    ...
    public void motors3(byte l, byte r, byte action, boolean speedReg, boolean motorSync) {
        byte[] data = { 0x0c, 0x00, (byte) 0x80, 0x04, 0x02, 0x32, 0x07, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00,
                        ...
                        0x0c, 0x00, (byte) 0x80, 0x05, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,//para sensor de color
                       // 0x0c, 0x00, (byte) 0x80, 0x05, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        };
...
//            data[61] = 0x00;
        ...
        if(!MainActivity.deshabilitar){
            data[47] = 0x05;//tipo custom para que tome el sensor de color
          //  data[61] = 0x0D;
        }
        write(data);
